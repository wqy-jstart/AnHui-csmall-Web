<template>
  <div>
    ...
    <el-form :model="ruleForm" :rules="rules" ref="ruleForm" style="width: 600px;" label-width="130px" class="demo-ruleForm">
  ...
  methods: {
    submitForm(formName) {
      ...
      this.$refs[formName].validate((valid) => {
        if (valid) { // 满足条件则通过验证
          let url = 'http://localhost:9900/attributeTemplates/insert'
          console.log('url = ' + url);
